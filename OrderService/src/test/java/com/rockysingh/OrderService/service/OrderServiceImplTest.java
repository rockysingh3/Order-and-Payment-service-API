...
import com.rockysingh.OrderService.model.*;
...
public class OrderServiceImplTest {
    ...
    // mock the services we are using in our OrderserviceImpl (service that I have injected in OrderserviceImpl)
    ...
    void test_When_Order_Success() {
        ...
        // Call the actual method from orderService API
    ...
    @DisplayName("Get Order - Falure Scenario")
    @Test
    void test_When_Get_Order_Not_FOUND_then_Not_Found() {
        ...
        *
        * Call the actual method from orderService API
        * We're handling the exception the orderRepo throws when the id is not found inh assertThrows
        *
        * */
    ...
    void test_When_Place_Order_Success() {
        ...
        // Mock the objects that will be tested
        Order order = getMockOrder();
...
//        we only want this request to fail
        when(paymentService.doPayment(any(PaymentRequest.class)))
